...
{\color{incolor}In [{\color{incolor}34}]:} \PY{c+c1}{\PYZsh{} Load standard data processing libraries}
         ...
         \PY{c+c1}{\PYZsh{} Assign project template directory}
         \PY{n}{data\PYZus{}dir} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{/Users/MT/Desktop/DS\PYZus{}Projects/CSC8635\PYZus{}ML\PYZus{}Project}\PY{l+s+s2}{\PYZdq{}}
         \PY{c+c1}{\PYZsh{} Import metadata df}
         \PY{n}{meta} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{read\PYZus{}csv}\PY{p}{(}\PY{n}{os}\PY{o}{.}\PY{n}{path}\PY{o}{.}\PY{n}{join}\PY{p}{(}\PY{n}{data\PYZus{}dir}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{data/HAM10000\PYZus{}metadata.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}
         ...
         \PY{k}{for} \PY{n+nb}{dir}\PY{p}{,}\PY{n}{\PYZus{}}\PY{p}{,}\PY{n}{\PYZus{}} \PY{o+ow}{in} \PY{n}{os}\PY{o}{.}\PY{n}{walk}\PY{p}{(}\PY{n}{data\PYZus{}dir}\PY{p}{)}\PY{p}{:}
...
\emph{pickle} file to allow quick reloading.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}70}]:} \PY{c+c1}{\PYZsh{} Iterate through images, resizing down to to 100x75 pixels, converting to array and inserting into new column}
         \PY{n}{meta}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{image}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{n}{meta}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{path}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{map}\PY{p}{(}\PY{k}{lambda} \PY{n}{x}\PY{p}{:} \PY{n}{np}\PY{o}{.}\PY{n}{asarray}\PY{p}{(}\PY{n}{Image}\PY{o}{.}\PY{n}{open}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{o}{.}\PY{n}{resize}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{100}\PY{p}{,}\PY{l+m+mi}{75}\PY{p}{)}\PY{p}{)}\PY{p}{)}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Cache result}
         \PY{n}{meta}\PY{o}{.}\PY{n}{to\PYZus{}pickle}\PY{p}{(}\PY{n}{os}\PY{o}{.}\PY{n}{path}\PY{o}{.}\PY{n}{join}\PY{p}{(}\PY{n}{data\PYZus{}dir}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{cache/meta\PYZus{}cache.p}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Import cached metadata df (uncomment to implement)}
         \PY{c+c1}{\PYZsh{} meta = pd.read\PYZus{}pickle(os.path.join(data\PYZus{}dir,\PYZsq{}cache/meta\PYZus{}cache.p\PYZsq{}))}
\end{Verbatim}
...
seed is set for each split
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}42}]:} \PY{c+c1}{\PYZsh{} Extract predictor variable (images) and labels as seperate vectors}
         ...
         \PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{X\PYZus{}validate}\PY{p}{,} \PY{n}{Y\PYZus{}train}\PY{p}{,} \PY{n}{Y\PYZus{}validate} \PY{o}{=} \PY{n}{train\PYZus{}test\PYZus{}split}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{Y\PYZus{}train}\PY{p}{,} \PY{n}{test\PYZus{}size} \PY{o}{=} \PY{l+m+mf}{0.1}\PY{p}{,} \PY{n}{random\PYZus{}state} \PY{o}{=} \PY{l+m+mi}{10}\PY{p}{)} 
\end{Verbatim}


    \hypertarget{data-modeling}{%
\paragraph{Data Modeling}\label{data-modeling}}
...
optimisation was accomplished using the Talos library.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} Import keras utilities}
...
The resulting model is shown below.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}51}]:} \PY{c+c1}{\PYZsh{} Set the CNN model }
...
reproducibility.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} Set random seed to ensure reproducability}
...
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} import talos}
        ...
        \PY{c+c1}{\PYZsh{}    model.add(BatchNormalization(input\PYZus{}shape=X\PYZus{}train.shape[1:]))}
            ...
            \PY{c+c1}{\PYZsh{} Extra layers not used}
        \PY{c+c1}{\PYZsh{}    model.add(BatchNormalization(input\PYZus{}shape=X\PYZus{}train.shape[1:]))}
...
your evidence in answering this question.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{loss}\PY{p}{,} \PY{n}{acc} \PY{o}{=} \PY{n}{model}\PY{o}{.}\PY{n}{evaluate}\PY{p}{(}\PY{n}{X\PYZus{}test}\PY{p}{,} \PY{n}{Y\PYZus{}test}\PY{p}{,} \PY{n}{verbose}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}
        \PY{n}{loss\PYZus{}val}\PY{p}{,} \PY{n}{acc\PYZus{}val} \PY{o}{=} \PY{n}{model}\PY{o}{.}\PY{n}{evaluate}\PY{p}{(}\PY{n}{X\PYZus{}val}\PY{p}{,} \PY{n}{Y\PYZus{}val}\PY{p}{,} \PY{n}{verbose}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}
        \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Validation: accuracy = }\PY{l+s+si}{\PYZpc{}f}\PY{l+s+s2}{  ;  loss\PYZus{}v = }\PY{l+s+si}{\PYZpc{}f}\PY{l+s+s2}{\PYZdq{}} \PY{o}{\PYZpc{}} \PY{p}{(}\PY{n}{acc\PYZus{}val}\PY{p}{,} \PY{n}{loss\PYZus{}val}\PY{p}{)}\PY{p}{)}
        \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Test: accuracy = }\PY{l+s+si}{\PYZpc{}f}\PY{l+s+s2}{  ;  loss = }\PY{l+s+si}{\PYZpc{}f}\PY{l+s+s2}{\PYZdq{}} \PY{o}{\PYZpc{}} \PY{p}{(}\PY{n}{accuracy}\PY{p}{,} \PY{n}{loss}\PY{p}{)}\PY{p}{)}
        
        \PY{c+c1}{\PYZsh{} Save model}
        \PY{n}{model}\PY{o}{.}\PY{n}{save}\PY{p}{(}\PY{n}{os}\PY{o}{.}\PY{n}{path}\PY{o}{.}\PY{n}{join}\PY{p}{(}\PY{n}{data\PYZus{}dir}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{cnn.hdf5}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
